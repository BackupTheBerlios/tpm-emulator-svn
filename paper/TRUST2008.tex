...
are worth to be noted here. They will be explained in more detail in the
talk:\marginpar{TODO}
\begin{enumerate}
	\item Kernel space vs. user space (solved since version 0.5),
	\item typographical errors in the specs and incomplete changelog,
	\item alignment of data structures (native/network byte order).
\end{enumerate}
...
\tpmcmdr{TPM\_NV\_ReadValueAuth}{1.2}{208}{M}{tpm\_nv\_storage.c}{}
