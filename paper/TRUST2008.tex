...
\noindent Currently, the following functions or commands are still missing:
\begin{itemize}
	\item some capability functions,
	\item all migration functions,
	\item all delegation functions,
	\item all non-volatile storage functions, and
	\item many optional commands.
\end{itemize}
