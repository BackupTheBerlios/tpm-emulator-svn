...
The two main criteria for evaluating the the presented software-based TPM
...
light-weight and computation-intensive TPM commands. One can observe that on
average, the emulator is about ten times faster than the hardware-based TPM for
computation-intensive commands. In the case of the light-weight command
TPM\_Extend, the performance advantage is even three orders of magnitude (i.e.,
factor $10^3$). This difference shows that the communication with a hardware
TPM constitutes a non negligible overhead.
...
\tpmcmdg{TPM\_Quote2}{1.2}{62}{M}{tpm\_integrity.c}{passed \cite{trousers,jTSS}}
